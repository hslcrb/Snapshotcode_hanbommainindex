...
initTimer = function() {
    ...
    if (iSecond > 0 && rMinute > 1) {
        ...
        location.href = "/" + sysId + "/lo/login/logout.html"; // ?¸ì…˜?„ì›ƒ
        //location.href = "/" + sysId + "/lo/login/timeLogout.html"; // ?¸ì…˜?„ì›ƒ
    }
}
...
function kcreTable() {
    ...
    str1 += "		<a href='/" + sysId + "/lo/login/logout.html' style='font-family:NotoSans, ?‹ì?, Dotum; display:inline-block; width: 120px; height:28px; line-height:24px; color:#fff; font-size:14px; text-align:center; background-color:#7c7d82; border:1px solid #6e6e72; margin-left:10px; text-decoration:none'>ë¡œê·¸?„ì›ƒ</a>";
    str1 += "	</div>";
    str1 += "	<a href='#' onClick='javascript:kdelTable();' title='?«ê¸°' style='position:absolute; width: 20px; height: 20px; padding: 0px; top: 9px;right: 12px;; border:0'><img src='./assets/images/'web/common/timeout/btn_close.gif' alt='?«ê¸°' style='border:0'></a> ";
    str1 += "</div> ";
